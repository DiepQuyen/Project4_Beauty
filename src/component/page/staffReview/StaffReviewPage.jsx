...
const StaffReviewPage = () => {
    ...
    const fetchStaffDetails = async () => {
        try {
            try {
                const response = await axios.get(`https://sparlex-spa.up.railway.app/api/v1/admin/accounts/find-by-id/${staffId}`);
    ...
    const fetchStaffReviews = async () => {
        try {
            const response = await axios.get(`https://sparlex-spa.up.railway.app/api/v1/reviews/item/staff/${staffId}`);
    ...
    const handleReviewSubmit = async (e) => {
        ...
        try {
            ...
            const response = await axios.post('https://sparlex-spa.up.railway.app/api/v1/reviews', payload, {
                headers: {
