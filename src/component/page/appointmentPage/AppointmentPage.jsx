...
const AppointmentPage = () => {
    ...
    // Check for serviceId in URL params and auto-select
    useEffect(() => {
    ...
    useEffect(() => {
        const checkAllStaffAvailability = async () => {
            ...
            const availabilityChecks = staffList.map(staff => {
                return axios.get('https://sparlex-spa.up.railway.app/api/v1/booking/staff-availability', {
                    params: {
                        userId: staff.id,
    ...
    const handleSubmit = async (e) => {
        ...
        if (!customerIdToSubmit && (formData.fullName && formData.phoneNumber)) {
            try {
                const res = await axios.post('https://sparlex-spa.up.railway.app/api/v1/customer/guest-create', {
                                    ...
                                    <div className="row gy-2 gx-2 gx-lg-3">
                                        ...
                                        <div className="col-12 col-lg-6">
                                            <input
                                                ...
                                                className={`form-control py-2 border-white bg-transparent text-white ${validationErrors.fullName ? 'border-danger' : ''}`}
                                        ...
                                        <div className="col-12 col-lg-6">
                                            <input
                                                ...
                                                onChange={handleInputChange}
                                                className={`form-control py-2 border-white bg-transparent text-white ${validationErrors.phoneNumber ? 'border-danger' : ''}`}
                                        ...
                                        <div className="col-12 mb-3">
                                            <div className="d-flex align-items-center justify-content-between flex-wrap mb-3">
                                                <h5 className="text-white-50 mb-0" style={{ fontSize: '0.85rem', fontWeight: '400', letterSpacing: '1px', textTransform: 'uppercase' }}>
                                                ...
                                                <div className="d-flex align-items-center" style={{ gap: '15px' }}>
                                                    <div style={{ position: 'relative' }}>
                                                        ...
                                                        <input
                                                            type="text"
                                                            className="form-control py-2 bg-transparent text-white"
                                                            placeholder="Search"
                                        ...
                                        {/* Staff Grid */}
                                        <div className="col-12">
                                            <div className="staff-directory-grid" style={{ maxHeight: '400px', overflowY: 'auto', padding: '10px', borderRadius: '10px', background: 'rgba(0,0,0,0.1)' }}>
                                        ...
                                        <div className="col-12">
                                            <div className="position-relative">
                                                <textarea
                                                    ...
                                                    onChange={handleInputChange}
                                                    className={`form-control border-white bg-transparent text-white ${validationErrors.notes ? 'border-danger' : ''}`}
                                                    rows="3"
