...
const CustomerDetail = () => {
    ...
    const fetchUserDetails = async (userId, token) => {
        try {
            const response = await axios.get(`https://sparlex-spa.up.railway.app/api/v1/customer/detail/${userId}`, {
    ...
    const handleProfileSubmit = async (e) => {
        ...
        try {
            ...
            const response = await axios.put(
                `https://sparlex-spa.up.railway.app/api/v1/customer/update-info/${user.id}`,
                formData,
    ...
    const handlePasswordSubmit = async (e) => {
        ...
        try {
            const response = await axios.put(
                `https://sparlex-spa.up.railway.app/api/v1/customer/change-password/${user.id}`,
                passwordInfo,
                { headers: { 'Authorization': `Bearer ${user.token}` } }
            );
            if (response.data && response.data.status === 'SUCCESS') {
